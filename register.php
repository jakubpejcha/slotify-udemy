			...
			<div id="inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="loginUsername" type="text" name="loginUsername" placeholder="e.g. JP" value="<?php getInputValue('loginUsername');  ?>" required>
					</p>
					<p>
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="username" type="text" name="username" placeholder="e.g. JP" value="<?php getInputValue('username');  ?>" required>
					</p>
					<p>
						<?= $account->getError(Constants::$firstNameCharacters); ?>
						<label for="firstName">First name</label>
						<input id="firstName" type="text" name="firstName" placeholder="e.g. Jakub" value="<?php getInputValue('firstName');  ?>" required>
					</p>
					<p>
						<?= $account->getError(Constants::$lastNameCharacters); ?>
						<label for="lastName">Last name</label>
						<input id="lastName" type="text" name="lastName" placeholder="e.g. Pejcha" value="<?php getInputValue('lastName');  ?>" required>
					</p>
					<p>
						...
						<input id="email" type="email" name="email" placeholder="e.g. jp@example.com" value="<?php getInputValue('email');  ?>" required>
					</p>
					<p>
						<label for="email2">Email confirm</label>
						<input id="email2" type="email" name="email2" placeholder="e.g. jp@example.com" value="<?php getInputValue('email2');  ?>" required>
					</p>
